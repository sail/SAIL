...
// public static final String SERVICE_URI = "ReportRequest";
 ...
 User userMng(User user,String method,Map<String,String> loginData);
 void addUser(String values);
 void editUser(String newValues, String string);
 public boolean delObject(int parseInt);
 void addUserToColl(String userId,String collectionId);
 public String[][] getUsersObject();
 void addMail(String mvalue,String method);
 String[] getMailConf();
 boolean changePwd(String oldPwd, String newPwd,User user);
