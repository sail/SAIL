...
public interface BackendServiceAsync
{
 ...
 void delPara(Integer ID, AsyncCallback<Boolean> callback);
 void sendMail(String msg,String pwd,String umail, AsyncCallback<Boolean> callback);
 void addUser(String values, AsyncCallback<Void> callback);

 void getUsersObject(AsyncCallback<String[][]> callback);
 void delObject(int parseInt, AsyncCallback<Boolean> asyncCallback);
 void editUser(String newValues, String string, AsyncCallback<Void> callback);
 void userMng(User user, String method, Map<String, String> loginData,AsyncCallback<User> callback);
 void addUserToColl(String userId, String collectionId,AsyncCallback<Void> callback);
 public void addMail(String mvalue, String method, AsyncCallback<Void> asyncCallback);
 public void getMailConf(AsyncCallback<String[]> asyncCallback);
 public void changePwd(String oldPwd, String newPwd, User user, AsyncCallback<Boolean> asyncCallback);
