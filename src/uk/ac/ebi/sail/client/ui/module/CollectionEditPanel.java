...
public class CollectionEditPanel extends FormPanel
{
 ...
 public CollectionEditPanel()
 {
  ...
  add( annEdit = new AnnotatedEditor( Target.COLLECTION_ANN ), new AnchorLayoutData("95%") );
 ...
 public void setObjectActionListener(ObjectAction<SampleCollection> objectAction)
 {
