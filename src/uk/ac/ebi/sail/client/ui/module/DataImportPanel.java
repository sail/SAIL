...
public class DataImportPanel extends Panel {
	public DataImportPanel() {
		...
		Button button = new Button("Upload Vocabulary",
				new ButtonListenerAdapter() {
					public void onClick(final Button button, EventObject e) {
						UploadDialog dialog = new UploadDialog();
						dialog.setUrl("sail/UploadSvc");
						// dialog.setPermittedExtensions(new String[]{"jpg",
						// "gif"});
						...
						dialog.setPermittedExtensions(new String[] { "txt",
								"TXT" });
						dialog.show();
					}
				});
		...
		button = new Button("Upload Relations", new ButtonListenerAdapter() {
			public void onClick(final Button button, EventObject e) {
				UploadDialog dialog = new UploadDialog();
				dialog.setUrl("sail/UploadSvc");
