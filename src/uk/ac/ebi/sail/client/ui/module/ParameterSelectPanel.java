...
public class ParameterSelectPanel extends Panel implements StudyCollectionStateListener
{
 private enum Tab
 {
  LIST,
...
// private ObjectSelectionListener<Parameter> selListener;
 ...
 public ParameterSelectPanel(boolean single, Action[] buttons, ClassifiableManager<Parameter> m)
 {
