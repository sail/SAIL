...
public class RealRangePanel extends FormPanel
{
 private TextField lowLim;
 private TextField upLim;
 
 private Range range;
 private ObjectAction<Range> listener;
 
 public RealRangePanel()
 {
  setFrame(true);
 ...
 public void setRange( Range v )
 {
  ...
  if( ! Float.isNaN(v.getLimitLow()) )
   lowLim.setValue( String.valueOf(v.getLimitLow()) );
  else
   lowLim.setValue("");
  
  if( ! Float.isNaN(v.getLimitHigh()) )
