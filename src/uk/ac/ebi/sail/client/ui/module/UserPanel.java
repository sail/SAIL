...
//  rp.setId("Summary");
  ...
  constructorTab = new ReportConstructorPanel( 
      new Action[] {
        new Action("Extra","extra","extraIcon",new Action[]
         {
          new Action(null,null),
          new Action("View parameter","up_view","viewIcon",null)
         })
       });
//      , new Action("Export","export"+ActionFlags.separator+ActionFlags.EMPTY)});
